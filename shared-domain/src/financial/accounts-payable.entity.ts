...
export const makeAccountsPayable = (props: {
  ...
  // stockLotId is optional during creation, will be set later via update
...
/**
 * Creates a new AccountsPayable with an added payment.
 * Validates that payment doesn't exceed remaining balance.
 */
export const addPaymentToAccountsPayable = (
  payable: IAccountsPayable,
